...
export interface DimensionConfig {
  ...
  emoji: string
  maxScore: number
  weight: number // as fraction of 100, e.g. 25 means 25/100
  description: string
}
 ...
 */
export const CHAT_CHECKLIST_TEMPLATE = [
  // A. Persona (4 items)
  { id: 'A1', category: 'persona' as const, categoryLabel: 'A 人设一致性', description: '使用标志性口头禅' },
  { id: 'A2', category: 'persona' as const, categoryLabel: 'A 人设一致性', description: '保持热情活力语气' },
  { id: 'A3', category: 'persona' as const, categoryLabel: 'A 人设一致性', description: '称呼方式一致 (姐妹/宝宝)' },
  { id: 'A4', category: 'persona' as const, categoryLabel: 'A 人设一致性', description: '不使用禁忌用语' },
  // B. Emotion (4 items)
  { id: 'B1', category: 'emotion' as const, categoryLabel: 'B 情绪共鸣', description: '识别用户情绪状态' },
  { id: 'B2', category: 'emotion' as const, categoryLabel: 'B 情绪共鸣', description: '给予共情回应' },
  { id: 'B3', category: 'emotion' as const, categoryLabel: 'B 情绪共鸣', description: '情绪强度匹配得当' },
  { id: 'B4', category: 'emotion' as const, categoryLabel: 'B 情绪共鸣', description: '避免过度热情或冷淡' },
  // C. Naturalness (3 items)
  { id: 'C1', category: 'naturalness' as const, categoryLabel: 'C 自然度', description: '话题过渡自然流畅' },
  { id: 'C2', category: 'naturalness' as const, categoryLabel: 'C 自然度', description: '避免机械化重复句式' },
  { id: 'C3', category: 'naturalness' as const, categoryLabel: 'C 自然度', description: '回复长度适中' },
  // D. Profile Use (3 items)
  { id: 'D1', category: 'profile' as const, categoryLabel: 'D 画像运用', description: '根据年龄段调整沟通风格' },
  { id: 'D2', category: 'profile' as const, categoryLabel: 'D 画像运用', description: '运用用户偏好信息推荐' },
  { id: 'D3', category: 'profile' as const, categoryLabel: 'D 画像运用', description: '区分35+/under35差异化表达' },
]

/**
 * Red line checks (apply to all scenes)
 */
export const RED_LINE_CHECKS = [
 ...
 */
export const FOLDER_SCENE_MAP: Record<string, SceneType> = {
